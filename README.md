...
- For the implementation of the Master-Worker algorithm, all results of benchmarking are available <a href="/paper_implementation/benchmarking/benchmark_results.csv">here</a>.
